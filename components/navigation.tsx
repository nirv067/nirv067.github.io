      ...
      <div className="max-w-6xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <button
            ...
            className="text-lg font-bold text-foreground hover:text-accent transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-accent rounded px-2"
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 space-y-2 pb-4 border-t border-border/50 pt-4">
            {navItems.map((item) => (
              <button
                key={item.id}
                onClick={() => scrollToSection(item.id)}
                className="block w-full text-left px-4 py-2 text-sm text-muted-foreground hover:text-accent hover:bg-secondary rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-accent"
                aria-label={`Go to ${item.label} section`}
              >
                {item.label}
              </button>
            ...
            <button
              onClick={() => scrollToSection("contact")}
              className="block w-full text-left px-4 py-2 text-sm rounded-lg bg-accent text-accent-foreground hover:shadow-lg transition-all duration-300 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary mt-4"
              aria-label="Go to contact section"
            >
              Connect
            </button>
